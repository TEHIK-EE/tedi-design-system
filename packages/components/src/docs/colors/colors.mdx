...
<Meta name="Colors" title="Documentation/Colors" />

# Color Tokens

The same design tokens are used for Figma and development. For more detailed info look at [guidelines](#guidelines) below.
