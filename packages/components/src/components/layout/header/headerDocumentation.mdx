...
**Note:** Pass those components directly as Header children to render them inside Settings area. They will be reordered to certain order. <br />
**Note-2:** In mobile breakpoints only HeaderLanguage and HeaderSettings are rendered. Other components should be rendered inside HeaderSettings dropdown/modal. <br />
