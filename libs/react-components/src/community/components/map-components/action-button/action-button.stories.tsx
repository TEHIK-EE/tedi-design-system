...
const meta: Meta<typeof ActionButton> = {
  ...
  title: 'Community/Map components/ActionButton',
};
...
type TemplateMultipleProps<Type = typeof buttonStateArray> = ActionButtonProps & {
  array: Type;
        ...
        {array.map((value, key) => (
          <Row key={key}>
            ...
            <Col className="display-flex align-items-center gap-3">
              <ActionButton id={value} {...buttonProps} selected={value === 'Selected'}>
                Text
              </ActionButton>
              <ActionButton id={value} {...buttonProps} iconRight="straighten" selected={value === 'Selected'}>
                Text
              </ActionButton>
              <ActionButton id={value} {...buttonProps} selected={value === 'Selected'}>
                Text
            ...
            <Col className="display-flex align-items-center gap-3">
              <ActionButton id={value} size="small" {...buttonProps} selected={value === 'Selected'}>
                Text
              </ActionButton>
              <ActionButton
                id={value}
              ...
              <ActionButton id={value} size="small" {...buttonProps} iconLeft="edit" selected={value === 'Selected'}>
                Text
              </ActionButton>
              <ActionButton
                id={value}
...
const TemplateGroup: StoryFn<ButtonGroupProps> = (args) => {
  return (
    <ButtonGroup {...args}>
      <ActionButton icon="location_on">Punkt</ActionButton>
      <ActionButton icon="straighten">Mõõda</ActionButton>
      <ActionButton icon="compare">Võrdle</ActionButton>
      <ActionButton icon="history">Ajajoon</ActionButton>
    </ButtonGroup>
  );
};
  ...
  return (
    <VerticalSpacing>
      <ButtonGroup suffix="Suffix" ariaLabel="Example button group">
        <ActionButton id="btn1" size="small" icon="location_on">
          Button 1
        </ActionButton>
        <ActionButton id="btn2" size="small" icon="history">
          Button 2
        </ActionButton>
      </ButtonGroup>
