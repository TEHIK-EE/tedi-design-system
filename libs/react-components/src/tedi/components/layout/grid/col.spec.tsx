...
describe('Col Component', () => {
  ...
  test('applies the correct classes based on props', () => {
    ...
    const colElement = container.querySelector('.col-6');
    expect(colElement).not.toBeNull();
    if (colElement) {
  ...
  test('applies grow and shrink classes correctly', () => {
    ...
    const colElement = container.querySelector('.flex-grow-1');
    expect(colElement).not.toBeNull();
    if (colElement) {
  ...
  test('renders the Col component with a different element', () => {
    ...
    const colElement = container.querySelector('dd');
    expect(colElement).not.toBeNull();
    if (colElement) {
  ...
  test('renders Col component with custom className', () => {
    ...
    const colElement = container.querySelector('.custom-col');
    expect(colElement).not.toBeNull();
    if (colElement) {
  ...
  test('applies all props together', () => {
    ...
    const colElement = container.querySelector('.col-8');
    expect(colElement).not.toBeNull();
    if (colElement) {
