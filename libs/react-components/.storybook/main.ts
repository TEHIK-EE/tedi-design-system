...
const config: StorybookConfig = {
  ...
  stories: [
    ...
    '../shared/docs/colors/colorTokens.mdx',
    '../shared/docs/colors/colorGuidelines.mdx',
    '../shared/docs/scale-layout/spacing.mdx',
    '../shared/docs/scale-layout/grid.mdx',
    '../shared/docs/labels/labels.mdx',
    '../shared/docs/printing.mdx',
